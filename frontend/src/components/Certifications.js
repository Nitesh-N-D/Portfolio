...
import { certifications } from "../data/certifications";
export default function Certifications() {
    return (_jsx(Reveal, { children: _jsx("section", { id: "certifications", style: styles.section, children: _jsxs(motion.div, { initial: { opacity: 0, y: 24 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.5, ease: "easeOut" }, viewport: { once: true }, style: styles.container, children: [_jsx("h2", { style: styles.heading, children: "Certifications" }), _jsx("p", { style: styles.subtitle, children: "Industry-recognized certifications validating my technical skills and continuous learning mindset." }), _jsx("div", { style: styles.grid, children: certifications.map((c, i) => (_jsx(motion.article, { style: styles.card, whileHover: { y: -4 }, transition: { type: "spring", stiffness: 140 }, children: _jsxs("div", { style: styles.content, children: [_jsx("h3", { style: styles.title, children: c.title }), _jsx("p", { style: styles.provider, children: c.provider }), _jsxs("span", { style: styles.issued, children: ["Issued ", c.issued] }), _jsx("a", { href: c.proof, target: "_blank", rel: "noopener noreferrer", style: styles.proofBtn, children: getProofLabel(c) })] }) }, i))) })] }) }) }));
}
/* ================= HELPERS ================= */
function getProofLabel(c) {
    if (c.type === "pdf")
