...
*/
export default function Experience() {
    return (_jsx("section", { id: "experience", style: styles.section, children: _jsx(Reveal, { children: _jsxs(motion.div, { initial: { opacity: 0, y: 24 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.5, ease: "easeOut" }, viewport: { once: true }, style: styles.container, children: [_jsx("h2", { style: styles.heading, children: "Experience" }), _jsx("p", { style: styles.subtitle, children: "Internships and hands-on industry experience where I applied engineering principles to real-world systems." }), _jsx("div", { style: styles.timeline, children: experience.map(exp => (_jsxs(motion.div, { style: styles.item, whileHover: { x: 6 }, transition: { type: "spring", stiffness: 140 }, children: [_jsx("span", { style: styles.dot }), _jsxs("div", { style: styles.card, children: [_jsx("h3", { style: styles.role, children: exp.role }), _jsx("p", { style: styles.company, children: exp.company }), _jsx("p", { style: styles.description, children: exp.description }), _jsxs("span", { style: styles.date, children: [exp.start, " \u2014 ", exp.end] })] })] }, exp.id))) })] }) }) }));
}
/* ===================== STYLES ===================== */
const styles = {
    section: {
