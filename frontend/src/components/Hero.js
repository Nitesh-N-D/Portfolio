...
import { FiGithub, FiLinkedin, FiMail } from "react-icons/fi";
export default function Hero() {
    return (_jsx("section", { id: "home", style: styles.section, children: _jsxs(motion.div, { initial: { opacity: 0, y: 32 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.7, ease: "easeOut" }, style: styles.container, children: [_jsxs("h1", { style: styles.title, children: ["N.D. ", _jsx("span", { style: styles.highlight, children: "Nitesh" })] }), _jsx("h2", { style: styles.subtitle, children: "Full Stack Developer \u00B7 Computer Science Engineer" }), _jsxs("p", { style: styles.description, children: ["I build scalable, production-ready web applications using modern technologies like ", _jsx("strong", { children: "React" }), ", ", _jsx("strong", { children: "Node.js" }), ", and ", _jsx("strong", { children: "cloud platforms" }), ". Passionate about clean code, system design, and solving real-world problems. Currently seeking internship and entry-level software engineering opportunities."] }), _jsxs("div", { style: styles.stats, children: [_jsxs("div", { style: styles.statCard, children: [_jsx("span", { style: styles.statNumber, children: "10+" }), _jsx("span", { style: styles.statLabel, children: "Projects Built" })] }), _jsxs("div", { style: styles.statCard, children: [_jsx("span", { style: styles.statNumber, children: "2+" }), _jsx("span", { style: styles.statLabel, children: "Years Learning" })] }), _jsxs("div", { style: styles.statCard, children: [_jsx("span", { style: styles.statNumber, children: "5+" }), _jsx("span", { style: styles.statLabel, children: "Core Technologies" })] })] }), _jsxs("div", { style: styles.actions, children: [_jsx("a", { href: "#projects", className: "btn", children: "View Projects" }), _jsx("a", { href: "#contact", className: "btn-outline", children: "Get In Touch" }), _jsx("a", { href: "/Nitesh_Resume.pdf", className: "btn-outline", download: true, children: "Download Resume" })] }), _jsxs("div", { style: styles.socials, children: [_jsx("a", { href: "https://github.com/Nitesh-N-D", target: "_blank", rel: "noopener noreferrer", "aria-label": "GitHub", style: styles.socialIcon, children: _jsx(FiGithub, { size: 20 }) }), _jsx("a", { href: "https://linkedin.com/in/nitesh-n-d-249ab6325", target: "_blank", rel: "noopener noreferrer", "aria-label": "LinkedIn", style: styles.socialIcon, children: _jsx(FiLinkedin, { size: 20 }) }), _jsx("a", { href: "mailto:niteshdwaraka@gmail.com", "aria-label": "Email", style: styles.socialIcon, children: _jsx(FiMail, { size: 20 }) })] })] }) }));
}
/* ==================== STYLES ==================== */
const styles = {
    section: {
