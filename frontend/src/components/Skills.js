...
import Reveal from "./Reveal";
import { FaJava, FaPython } from "react-icons/fa";
import { SiC, SiCplusplus, SiJavascript, SiReact, SiNodedotjs, SiExpress, SiMongodb, SiMysql, SiGit, SiGithub, SiHtml5, SiCss3 } from "react-icons/si";
/* ================= DATA ================= */
const skillGroups = [
    {
        title: "Programming Languages",
        skills: [
            { name: "C", level: "Intermediate", icon: _jsx(SiC, {}) },
            { name: "C++", level: "Intermediate", icon: _jsx(SiCplusplus, {}) },
            { name: "Java", level: "Advanced", icon: _jsx(FaJava, {}) },
            { name: "Python", level: "Intermediate", icon: _jsx(FaPython, {}) },
            { name: "JavaScript", level: "Advanced", icon: _jsx(SiJavascript, {}) }
        ]
    },
    {
        title: "Frontend Development",
        skills: [
            { name: "React", level: "Intermediate", icon: _jsx(SiReact, {}) },
            { name: "HTML", level: "Advanced", icon: _jsx(SiHtml5, {}) },
            { name: "CSS", level: "Intermediate", icon: _jsx(SiCss3, {}) }
        ]
    },
    {
        title: "Backend Development",
        skills: [
            { name: "Node.js", level: "Intermediate", icon: _jsx(SiNodedotjs, {}) },
            { name: "Express", level: "Intermediate", icon: _jsx(SiExpress, {}) }
        ]
    },
    {
        title: "Databases",
        skills: [
            { name: "MySQL", level: "Intermediate", icon: _jsx(SiMysql, {}) },
            { name: "MongoDB", level: "Beginner", icon: _jsx(SiMongodb, {}) }
        ]
    },
    {
        title: "Tools & Version Control",
        skills: [
            { name: "Git", level: "Intermediate", icon: _jsx(SiGit, {}) },
            { name: "GitHub", level: "Intermediate", icon: _jsx(SiGithub, {}) }
        ]
    }
];
/* ================= COMPONENT ================= */
export default function Skills() {
    return (_jsx("section", { id: "skills", style: styles.section, children: _jsx(Reveal, { children: _jsxs(motion.div, { initial: { opacity: 0, y: 24 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.5, ease: "easeOut" }, viewport: { once: true }, style: styles.container, children: [_jsx("h2", { style: styles.heading, children: "Skills & Technologies" }), _jsx("p", { style: styles.subtitle, children: "A concised overview of programming languages, frameworks, tools, and technologies I use to build reliable software." }), _jsx("div", { style: styles.grid, children: skillGroups.map((group, index) => (_jsxs(motion.div, { style: styles.groupCard, whileHover: { y: -4 }, transition: { type: "spring", stiffness: 140 }, children: [_jsx("h3", { style: styles.groupTitle, children: group.title }), _jsx("div", { style: styles.skillList, children: group.skills.map((skill, i) => (_jsxs("div", { style: styles.skillItem, children: [_jsxs("div", { style: styles.skillLeft, children: [_jsx("span", { style: styles.icon, children: skill.icon }), _jsx("span", { children: skill.name })] }), _jsx("span", { style: {
                                                    ...styles.level,
                                                    ...levelStyles[skill.level]
                                                }, children: skill.level })] }, i))) })] }, index))) })] }) }) }));
}
/* ================= STYLES ================= */
const styles = {
    section: {
